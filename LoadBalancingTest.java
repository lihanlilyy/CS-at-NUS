...
public class LoadBalancingTest {
    ...
    public void testFeasibleLoad2() {
        int[] jobs = {2, 3, 4, 5, 6, 7, 8, 100, 99, 98, 97, 96, 95, 94, 93, 92, 91, 90, 89, 88, 87, 86, 85, 84, 83};
        int processors = 8;
        int queryLoad = 261;
    ...
    public void testFindLoad1() {
        ...
        int processors = 1;
        System.out.println(LoadBalancing.findLoad(jobSize, processors));

        assertEquals(LoadBalancing.findLoad(jobSize, processors), 64);
    }
